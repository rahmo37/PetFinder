    ...
    for ($i = 0; $i < $result->num_rows; $i++) {
      ...
      <div class="container" data-report-id="{$reportID}">
        <div class="img-name-container">
          ...
          <button id="accept" onclick="updateReportStatus(this,'{$reportID}', 'Accepted', 'lost');">&#x2714;</button>
          <button id="reject" onclick="updateReportStatus(this,'{$reportID}', 'Rejected', 'lost');">&#x2715;</button>
          </div>
        </div>
      ...
      $htmlContent = <<<HTML
        <div class="container" data-report-id="{$reportID}">
          <div class="img-name-container">
            ...
            <p id="message" style="opacity: 0"></p>
            <div class="reportStatusBtn">
            <button id="accept" onclick="updateReportStatus(this,'{$reportID}', 'Accepted', 'found');">&#x2714;</button>
          <button id="reject" onclick="updateReportStatus(this,'{$reportID}', 'Rejected', 'found');">&#x2715;</button>
        </div>
          </div>
...
<script>
  function updateReportStatus(buttonElement, reportId, status, reportType) {
      ...
      fetch('processReport.php', {
        ...
        .then(data => {
          ...
          if (data === "Successful") {
            ...
            // Dynamically Styling the confirmation message
